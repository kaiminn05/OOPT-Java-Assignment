...
ClearScreenUtil.java: Utility class for clearing the console screen.
...
Menu includes options for inventory management, stock in, supplier management, and logout.

Stock In & Restock Module:
Provides options to view stock levels, add new stock, update, and delete items.
Menu includes options for viewing stock, low stock alerts, adding, updating, and deleting stock.

Supplier Management Module:
Manages supplier information, tracks performance, and handles supplier-related actions.
Menu includes options for adding, updating, tracking, and displaying supplier performance.